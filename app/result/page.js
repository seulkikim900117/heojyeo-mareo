...
const p = s.pillars;
const total = s.elements.raw.reduce((a, b) => a + b, 0) || 1;
return (
<div className="card">
...
<span
className="elem-fill"
style={{ width: (s.elements.raw[i] / total) * 100 + "%", background: ELEM_COLORS[i] }}
/>
</span>
<span className="elem-count">{s.elements.percent[e]}%</span>
</div>
))}
